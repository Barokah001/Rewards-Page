...
export const FeaturedTool: React.FC = () => {
  return (
    <div className="relative bg-gradient-to-br from-[#7C3AED] to-[#3B82F6] rounded-[24px] p-6 text-white relative shadow-xl flex flex-col justify-between transition-transform duration-300 hover:scale-[1.02]">
      ...
      <span className="bg-white/20 text-white text-xs font-bold px-3 py-1 rounded-full backdrop-blur-sm uppercase tracking-wider w-1/3">
        Featured
      </span>

      <h2 className="text-3xl font-black mt-4 mb-2">Top Tool Spotlight</h2>
      <h3 className="text-2xl font-bold opacity-90 mb-4">Reclaim</h3>

      <div className="bg-white rounded-[24px] p-6 text-gray-800 shadow-inner">
        <div className="flex flex-col gap-3">
          <div className="bg-purple-50 p-3 rounded-xl h-fit w-fit">📅</div>
          <div>
